...
const featuredProjects = [
  {
    ...
    description: "HireReady.AI is a production-ready AI-powered SaaS platform that analyzes resumes, generates ATS optimization reports, identifies skill gaps, and helps users match with relevant job opportunities. Built with secure authentication, persistent user data, AI-powered resume analysis, PDF parsing, and cloud deployment.",
    features: ["AI Resume Analysis", "ATS Optimization", "Job Matching", "Authentication", "PostgreSQL", "Prisma", "Supabase", "Gemini API", "SaaS", "Cloud Deployment"],
